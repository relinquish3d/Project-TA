    ...
    <div class="min-h-screen flex items-center justify-center bg-black">
        <div class="w-full max-w-4xl h-[640px] bg-white border-4 border-blue-950 rounded-4xl grid grid-cols-2 overflow-hidden">
            ...
            <div class="min-w-0 h-full p-8 flex flex-col justify-center overflow-y-auto">
                ...
                <p class="text-sm italic text-gray-500 mt-1 mb-6">Sign in to continue to your account.</p>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 border border-gray-300 rounded-full px-4 py-2 bg-white">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus
                                ...
                                class="h-7 w-100 border-0 focus:ring-0 p-0 text-sm bg-white text-gray-900 italic placeholder-gray-400" rounded-full>
                        </div>
                ...
                <p class="text-center text-sm text-gray-700 mt-4">
                    ...
                    <a href="{{ route('register') }}" class="text-blue-600 font-medium hover:underline">Create account</a>
                    @endif
                </p>
                ...
                <div class="mt-4 space-y-3">
                    <button type="button"
                        class="w-full flex items-center gap-3 border border-gray-300 rounded-full px-4 py-2 hover:bg-gray-100 transition">
