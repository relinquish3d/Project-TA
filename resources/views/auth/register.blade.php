            ...
            <div class="min-w-0 h-full rounded-3xl bg-gray-300 p-6 flex items-center justify-center">
                <div class="w-full h-full bg-gray-200 rounded-4xl border border-gray-400 flex flex-col items-center justify-between py-6">
                    ...
                    <div class="flex-1 flex items-center justify-center">
                        <a href="{{ url('/') }}">
                            <img src="{{ asset('images/logo.png') }}" alt="PlayAll" class="">
                        </a>
                    </div>
            ...
            <div class="min-w-0 h-full p-8 flex flex-col justify-center overflow-y-auto">
                ...
                <form method="POST" action="{{ route('register.step1') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 border border-gray-300 rounded-full px-4 py-2 bg-white transition-all duration-200 focus-within:border-blue-950 focus-within:ring-2 focus-within:ring-blue-950/10">
                            ...
                            <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus placeholder="Add name"
                                class="h-7 w-full focus:outline-none border-0 focus:ring-0 p-0 text-sm bg-white text-gray-900 italic placeholder-gray-400">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 border border-gray-300 rounded-full px-4 py-2 bg-white transition-all duration-200 focus-within:border-blue-950 focus-within:ring-2 focus-within:ring-blue-950/10">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}" required placeholder="Example@example.com"
                                class="h-7 w-full focus:outline-none border-0 focus:ring-0 p-0 text-sm bg-white text-gray-900 italic placeholder-gray-400">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 border border-gray-300 rounded-full px-4 py-2 bg-white transition-all duration-200 focus-within:border-blue-950 focus-within:ring-2 focus-within:ring-blue-950/10">
                            ...
                            <input id="password" type="password" name="password" required placeholder="********"
                                class="h-7 w-full focus:outline-none border-0 focus:ring-0 p-0 text-sm bg-white text-gray-900 placeholder-gray-400">
                        </div>
                    ...
                    {{-- Tombol Next --}}
                    <div class="pt-2">
                        <button type="submit" class="w-full border border-gray-300 rounded-full py-2 text-sm text-gray-700 hover:bg-gray-100 transition-all">
                            {{ __('Next') }}
                        </button>
                    </div>
                </form>
